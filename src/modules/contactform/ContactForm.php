<form class="contactForm" action="/api/contactForm" method="POST">
  ...
  <div class="contactForm-inputWrapper contactForm-inputWrapper--name">
    <input class="contactForm-inputText" placeholder="Name" type="text" name="name"
      v-validate="'required'"
      data-vv-as="Name"
      :class="{'contactForm-inputText--error': errors.has('name')}"
      v-model="form.name"
    >
  ...
  <div class="contactForm-inputWrapper contactForm-inputWrapper--email">
    <input class="contactForm-inputText" placeholder="Email" type="text" name="email"
      ...
      data-vv-as="E-Mail"
      :class="{'contactForm-inputText--error': errors.has('email')}"
      v-model="form.email"
    >
  ...
  <input class="contactForm-inputText" placeholder="Betreff" type="text" name="subject"
      v-validate="'required'"
      data-vv-as="Betreff"
      :class="{'contactForm-inputText--error': errors.has('subject')}"
  ...
  <div class="contactForm-inputWrapper contactForm-inputWrapper--message">
    <textarea name="message" class="contactForm-textarea" name="message" placeholder="Nachricht…"
      ...
      :class="{'contactForm-textarea--error': errors.has('message')}"
  ...
  <div class="contactForm-messageAndSend">
    <div class="contactForm-message contactForm-message--success" v-if="status === 'success'">
      Übermittlung erfolgreich. Vielen dank für Ihre Nachricht.
    </div>
    <div class="contactForm-message contactForm-message--error" v-if="status=== 'error'">
